...
class DefaultPreferences(
    //SharedPreferences used to save small and simple values such as application settings or user preferences
    // in this case we will save user info like gender, age, weight,...
