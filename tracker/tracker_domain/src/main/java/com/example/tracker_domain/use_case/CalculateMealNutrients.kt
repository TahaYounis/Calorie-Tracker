...
class CalculateMealNutrients(
    ...
    // preferences have the value that you will need it to get total calorie amount that you will eat per day
    // we need carb, protein, fat, calorie goals, we need other values like for how many ate in specific day
    // we also this values for all single meal type to calculate how many calories, carbs,... you ate
    // we will provide this value in form of hashmap
    ...
    operator fun invoke(trackedFood:List<TrackedFood>):Result{
        ...
        val caloryGoal = dailyCalorieRequirement(userInfo)
        val carbsGoal = (caloryGoal * userInfo.carbRatio / 4f).roundToInt() // we divided it by 4f because 1gm of carbs has 4 calories
